        ...
        <div className={cn("relative flex min-h-svh flex-col bg-background", className)}>
            ...
            {showBranding ? (
                <Link
                    href="/form"
                    prefetch={false}
                    className="fixed left-4 top-4 z-30 inline-flex items-center gap-2 rounded-full border border-border/50 bg-background/70 px-3 py-1.5 text-sm text-muted-foreground backdrop-blur-sm transition-colors hover:text-foreground sm:left-6 sm:top-6"
                >
