...
export const CLAIMS: Claim[] = [
...

    {
        ...
        statement: "Passwordless authentication with magic links",
        class: "verified_in_repo",
    ...
    },
    {
        ...
        statement: "Atomic download limit enforcement",
        class: "verified_in_repo",
        category: "access_control",
    ...
    {
        id: "rate_limiting",
        statement: "Rate limiting on all API endpoints",
        class: "verified_in_repo",
        category: "access_control",
        verificationPath: "lib/rate-limit.ts",
        lastVerified: "2026-04-05",
        caveats: [
            "Applied per-route; high-risk Drop routes now use the declarative policy layer, with broader rollout still in progress",
        ],
        appliesTo: ["both"],
    },
    ...
    {
        id: "no_registration_drop",
        statement: "No registration required for file sharing",
        shortLabel: "No Registration Required",
        class: "verified_in_repo",
        category: "access_control",
        verificationPath: "app/api/v1/drop/route.ts",
        lastVerified: "2026-04-05",
        caveats: [
            "Guest drops are limited to 3GB and 1-day expiry",
        ],
        appliesTo: ["drop"],
    },
    {
        ...
        lastVerified: "2026-04-05",
        caveats: [
            "250GB is the Pro tier limit; free tier is 5GB, guest is 3GB",
        ],
        appliesTo: ["drop"],
    },
]
