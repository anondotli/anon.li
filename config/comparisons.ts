...
export const comparisons: ComparisonEntry[] = [
    ...
    },
    {
        ...
        description: "WeTransfer is a polished transfer workflow with previews, requests, mobile apps, and a 1TB top tier. anon.li focuses on provider-blind encryption, anonymous guest sends, and privacy automation.",
        lastVerified: "2026-07-13",
        sourceUrl: "https://wetransfer.com/help-center/subscriptions/plan-limits",
        sourceName: "WeTransfer Plan Limits",
        comparisonData: {
            features: [
                {
                    category: "Transfer Limits",
                    items: [
                        { feature: "Free transfer allowance", anonli: "5GB account bandwidth; limited 100MB guest sends", competitor: "10 transfers or 3GB in a rolling 30-day window", source: "https://wetransfer.com/help-center/subscriptions/plan-limits", sourceLabel: "WeTransfer Plan Limits" },
                        { feature: "Largest published transfer tier", anonli: "250GB on Drop Pro", competitor: "1TB per transfer on Ultimate", source: "https://wetransfer.com/help-center/subscriptions/plan-limits", sourceLabel: "WeTransfer Plan Limits" },
                        { feature: "No-account sending", anonli: "Yes, for limited guest drops", competitor: false, source: "https://wetransfer.com/resources/free-file-transfer/wetransfer-free-plan", sourceLabel: "WeTransfer Free Plan" },
                ...
                },
                {
                    ...
                    items: [
                        { feature: "Client-side encryption before upload", anonli: true, competitor: false, source: "https://wetransfer.com/help-center/security-privacy/platform-security", sourceLabel: "WeTransfer Security Model" },
                        { feature: "Provider-blind file content", anonli: true, competitor: false, source: "https://wetransfer.com/help-center/security-privacy/file-handling-policy", sourceLabel: "WeTransfer File Handling" },
                        { feature: "Password protection", anonli: "Paid Drop plans", competitor: "All plans, including Free", source: "https://wetransfer.com/resources/free-file-transfer/wetransfer-free-plan", sourceLabel: "WeTransfer Free Plan" },
                        { feature: "Recipient access restriction", anonli: "Plus and Pro", competitor: "All plans, including Free", source: "https://wetransfer.com/resources/free-file-transfer/wetransfer-free-plan", sourceLabel: "WeTransfer Free Plan" },
                        { feature: "File requests", anonli: false, competitor: true, source: "https://wetransfer.com/help-center/how-to/track-file-requests", sourceLabel: "WeTransfer File Requests" },
                ...
                },
                {
                    ...
                    items: [
                        { feature: "Email aliases included", anonli: true, competitor: false },
                        { feature: "Open source web app", anonli: true, competitor: false, ...anonSourceCode },
                        { feature: "Folder hierarchy", anonli: "Preserved", competitor: "Flattened unless the sender pre-zips", source: "https://wetransfer.com/help-center/how-to/send-a-transfer", sourceLabel: "WeTransfer Sending Guide" },
                        { feature: "Native mobile apps", anonli: false, competitor: true, source: "https://wetransfer.com/help-center/how-to/send-a-transfer", sourceLabel: "WeTransfer Sending Guide" },
                        { feature: "Custom transfer branding", anonli: "Remove anon.li branding on Pro", competitor: "Ultimate feature", source: "https://wetransfer.com/help-center/subscriptions/plan-limits", sourceLabel: "WeTransfer Plan Limits" },
                        { feature: "Starting paid file-transfer plan", anonli: "$2.99/mo Drop Plus", competitor: "$6.99/mo Starter at last official announcement", source: "https://pressage.wetransfer.com/blog/story/2025-wetransfer-plans-remix-see-our-latest-plans", sourceLabel: "WeTransfer Plan Announcement" },
                    ],
                },
            ],
            pricing: [],
        },
        bottomLine: "WeTransfer is stronger for familiar creative delivery, 1TB transfers, requests, previews, and native mobile workflows. anon.li is the better pick when the provider itself must be unable to decrypt the transfer, or when anonymous sending and privacy automation matter.",
        anonliPros: ["Provider-blind Drop encryption", "Limited anonymous guest sends", "Email aliases and automation included", "Open source web app"],
        competitorPros: ["1TB paid transfer ceiling", "Free passwords and access restriction", "File requests and previews", "Mature mobile and team workflows"],
        whoShouldUseData: {
            anonLi: ["Send confidential files", "Want the provider unable to read file contents", "Need aliases and encrypted links together"],
            competitor: ["Need file request links or mobile apps", "Send files above 250GB", "Want mature previews, branding, and team administration"],
        },
    },
    {
        id: "simplelogin",
