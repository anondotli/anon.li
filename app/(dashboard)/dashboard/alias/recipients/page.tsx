    ...
    return (
        <div className="flex flex-col gap-8">
            <div className="flex items-center justify-between border-b border-border/40 pb-6">
                <div className="space-y-1">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-3xl font-medium tracking-tight font-serif">Recipients</h2>
                    </div>
                    <p className="text-muted-foreground font-light ml-11">
            ...
            {recipientLimit !== -1 && recipientCount >= recipientLimit && (
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm bg-destructive/10 text-destructive border border-destructive/20">
                    <span>
