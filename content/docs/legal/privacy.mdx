...
- **Account Data**: Retained as long as your account is active. Upon account deletion, aliases, domains, files, drops, API keys, credentials, and vault materials are removed from active systems immediately; any saved local browser trust becomes unusable, and the retained user record and rolling backups are permanently removed within 30 days.
