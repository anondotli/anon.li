...
Alias labels and notes are encrypted with your web vault. The public API does not accept plaintext label values, so labels are managed in the dashboard unless your CLI client implements compatible vault encryption.
