...
This guide walks through setting up your account and using the two core tools: **Alias** for private email forwarding and **Drop** for encrypted file sharing.
...
The alias is now active. Any email sent to it forwards to your real address.
...
No need to unsubscribe or mark as spam — just switch the alias off.
...
That covers the basics. For how the encryption works under the hood, see [Security](/security).
